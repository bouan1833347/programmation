...
public class Picdeglace extends Sort {
    ...
    public void LancerSort(Personnage attaque, Personnage attaquant)
    {
        if(attaquant.getPtdemagie()>=5)
        {
            ...
            System.out.println("Le"+attaquant+"lance pic de glace,ce qui lui coute 5 point de magie. il lui reste "+(attaquant.getPtdemagie()-5)+" point de magie et inflige "+(7-attaque.getPtdarmure())+"il lui reste "+(attaque.getPtdevie()-(7-attaque.getPtdarmure()))+" point de vie");

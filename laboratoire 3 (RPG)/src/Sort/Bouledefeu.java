...
public class Bouledefeu extends Sort {
    ...
    public void LancerSort(Personnage attaque, Personnage attaquant)
    {
        if(attaquant.getPtdemagie()>=5)
        {
            ...
            System.out.println("le"+attaquant+"lance le sort boule de feu,ce qui lui coute 5 point de magie. il lui reste "+(attaquant.getPtdemagie()-5)+" point de magie et inflige 5 dégat a "+attaque+"et il lui reste "+(attaque.getPtdevie()-5)+" point de vie");

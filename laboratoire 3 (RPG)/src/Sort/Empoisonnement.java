...
public class Empoisonnement extends Sort {
    ...
    public void LancerSort(Personnage attaque, Personnage attaquant)
    {
        if(attaquant.getPtdemagie()>=2)
        {
            ...
            System.out.println("le"+attaquant+"lance Empoisonement,ce qui lui coute 2 point de magie. il lui reste "+(attaquant.getPtdemagie()-2)+" point de magie et inflige "+(2+degat)+". il lui reste"+(attaque.getPtdevie()-(2+degat))+" point de vie");
